...
CREATE TABLE IF NOT EXISTS `coupon-pool` (
  ...
  `coupon_code` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '劵码',
  `coupon_type` int(11) DEFAULT NULL COMMENT '电子劵类型',
  `coupon_type_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '电子劵发型名称',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `coupon-code` (`coupon_code`)
